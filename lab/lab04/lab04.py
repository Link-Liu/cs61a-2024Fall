...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    distance1 = get_lat(city_a) - get_lat(city_b)
    distance2 = get_lon(city_a) - get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    return get_name(city_a) if distance(goal,city_a)< distance(goal,city_b) else get_name(city_b)
